...
component, #39 gained Cipolla cross-checking Tonelli, #40 gained Pollard-rho cross-checking BSGS). The 3 remaining
PARTIALS (#17 Hermite, #25 CP/Tucker tensor decomposition, #38 p−1/ECM factorization) are NOT gaps — each names
only a missing SUB-variant (e.g.
