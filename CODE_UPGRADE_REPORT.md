...
**Status (MEASURED, honest — never rounded up to "50 done"):** **43 CONFIRMED + 7 PARTIAL + 0 GAP** — §1 COMPLETE:
...
gained Möbius μ, #42 gained the Stern–Brocot tree). The 7 PARTIALS are NOT gaps — each names only a missing
SUB-variant (e.g.
