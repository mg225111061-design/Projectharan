...
| 테스트 | **213 통과 / 213** (`test_build.py`, 결정론 실행; 아래 명령) |
...
| 진행 중 | **UNIFIED ARSENAL**(a 변환계 + b ~70 fold 패밀리 + c 물리) — 기초 먼저: §1·G1 Ore ✅ · G2 holonomic ✅ · G3 telescoping ✅ → G4 → §2 결정절차 → §3 물리 → §4 변환. (NATIVE-CORE 완료: `NATIVE_CORE_REPORT.md`.) |
