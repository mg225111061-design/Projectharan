...
| 테스트 | **211 통과 / 211** (`test_build.py`, 결정론 실행; 아래 명령) |
...
| 진행 중 | **UNIFIED ARSENAL**(a 변환계 + b ~70 fold 패밀리 + c 물리) — 기초 먼저: §1·G1 Ore 코어 ✅ → G2/G3/G4 → §2 결정절차 → §3 물리 → §4 변환. (NATIVE-CORE 완료: `NATIVE_CORE_REPORT.md`.) |
