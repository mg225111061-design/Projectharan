...
| 테스트 | **231 통과 / 231** (`test_build.py`, 결정론 실행; 아래 명령) |
...
| 진행 중 | **UNIFIED ARSENAL**(a 변환계 + b ~70 fold 패밀리 + c 물리) — 기초 먼저: §1 ✅ (G1·G2·G3·G4) → §2 ✅ (Petkovšek·Abramov·Risch·Kovacic·CAD) → §3 물리: P7·P2·P6·P9·P5·P8·P1 ✅ · P3 Petrov ✅ · P4 Cartan–Karlhede ✅ (physics P1–P9 ✅) → §4 transforms: T-symbolic-dynamics·T-number-system·T-structure+randomness ✅ → **MATH recognition PHASE-1 ✅** (robust parser + fast kernels: modexp/fib/Faulhaber/Lucas-Lehmer/collatz, 3-way DECLINE) → §4 변환. (NATIVE-CORE 완료: `NATIVE_CORE_REPORT.md`.) |
