...
_CONDITION = {
    ...
    "mpst_projection_coherence": "full_abstraction",   # MPST → FACE of M17 (local-to-global gluing; M13 safety lineage)
    "fractional_edge_cover": "completeness",           # edge-cover/AGM → FACE of M10 (structure-forced size bound)
