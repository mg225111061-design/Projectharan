...
def _apply(x, **kw):
    ...
    if isinstance(x, dict) and "kb_rules" in x and "u" in x and "v" in x:   # Knuth–Bendix monoid word problem (native)
        import native_rewrite
        return native_rewrite.m8_word_grade(x)
