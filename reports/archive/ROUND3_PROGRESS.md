...
64. ☑ CEGAR — counterexample-guided abstraction refinement for loop invariants; coarse invariant (True) can't prove x≠51 → refine with x%2==0 (keeps inductive) → PROVEN EXACT; false x≠50 (50 reachable) → bounded-reachability witness → REFUTED/DECLINE (never false safe) [test_round3_cegar_refinement; pillar3/cegar.py]
